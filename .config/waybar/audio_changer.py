...
# function to parse output of command "wpctl status"
# and return a dictionary of sinks with their id and name.
...
# get the list of sinks ready to put into
# rofi - highlight the current default sink
output = ''
...
# Call rofi and show the list.
# take the selected sink name and set it as the default sink
rofi_command = f"echo '{output}' | rofi -dmenu -i"
rofi_process = subprocess.run(
    rofi_command, shell=True,
